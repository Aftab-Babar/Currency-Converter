package com.aftab.currencies.viewmodel.preference
...
import com.aftab.currencies.repository.ExchangeRatesRepository
import com.aftab.currencies.view.main.MainActivity
import com.aftab.currencies.view.preference.PreferenceActivity

class PreferenceViewModel(private val app: Application) : AndroidViewModel(app) {

    private var apiProvider: LiveData<com.aftab.currencies.model.ApiProvider> = Database(app).getApiProviderAsync()
    ...
    fun getApiProvider(): LiveData<com.aftab.currencies.model.ApiProvider> {
        return apiProvider
    }
