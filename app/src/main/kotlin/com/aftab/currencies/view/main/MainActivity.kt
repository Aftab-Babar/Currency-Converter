package com.aftab.currencies.view.main
...
import com.aftab.currencies.util.getDecimalSeparator
import com.aftab.currencies.util.getLocale
import com.aftab.currencies.util.toHumanReadableNumber
import com.aftab.currencies.util.toNumber
import com.aftab.currencies.view.BaseActivity
import com.aftab.currencies.view.main.spinner.SearchableSpinner
import com.aftab.currencies.view.timeline.TimelineActivity
import com.aftab.currencies.viewmodel.main.MainViewModel
                            ...
                            .firstOrNull()?.let { foldingFeature ->
                                ...
                                if (foldingFeature.state == FoldingFeature.State.FLAT) {
                                    ...
                                    if (resources.configuration.screenHeightDp >= resources.configuration.screenWidthDp)
                                        findViewById<LinearLayout>(R.id.main_root).orientation =
