...
import com.aftab.currencies.BuildConfig
import com.aftab.currencies.R
import com.aftab.currencies.model.ApiProvider
import com.aftab.currencies.util.toHumanReadableNumber
import com.aftab.currencies.viewmodel.preference.PreferenceViewModel
import com.aftab.currencies.widget.EditTextSwitchPreference
import com.aftab.currencies.widget.LongSummaryPreference
import java.util.*
...
class PreferenceFragment: PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        // transaction fee
        val feePreference = findPreference<com.aftab.currencies.widget.EditTextSwitchPreference>(getString(R.string.fee_key))
        ...
        findPreference<ListPreference>(getString(R.string.api_key))?.apply {
            setOnPreferenceChangeListener { _, newValue ->
                com.aftab.currencies.model.ApiProvider.fromNumber(newValue.toString().toInt())
        ...
        viewModel.getApiProvider().observe(this) {
            findPreference<com.aftab.currencies.widget.LongSummaryPreference>(getString(R.string.key_apiProvider))?.apply {
                title =
                    resources.getString(R.string.api_about_title, it.getName(context))
                summary =
                    it.getDescription(context)
            }
            findPreference<com.aftab.currencies.widget.LongSummaryPreference>(getString(R.string.key_refreshPeriod))?.summary =
